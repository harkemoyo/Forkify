var e,t,r,n,i,o,a,s,c,u,l,d,f,p,h,v,g,m,y,b=globalThis;function _(e){return e&&e.__esModule?e.default:e}var w={},k={},S=function(e){return e&&e.Math===Math&&e};// https://github.com/zloirock/core-js/issues/86#issuecomment-115759028
...
return"function"!=typeof e||e.hasOwnProperty("prototype")});var O=Function.prototype.call;j=$?O.bind(O):function(){return O.apply(O,arguments)};var L={}.propertyIsEnumerable,M=Object.getOwnPropertyDescriptor;o=M&&!L.call({1:2},1)?function(e){var t=M(this,e);return!!t&&t.enumerable}:L;var P={};P=function(e,t){return{enumerable:!(1&e),configurable:!(2&e),writable:!(4&e),value:t}};var x={},T={},H={},I=Function.prototype,q=I.call,C=$&&I.bind.bind(q,q),A={},N=(H=$?C:function(e){return function(){return q.apply(e,arguments)}})({}.toString),R=H("".slice);A=function(e){return R(N(e),8,-1)};var D=Object,U=H("".split);// fallback for non-array-like ES3 and non-enumerable old V8 strings
T=F(function(){// throws an error in rhino, see https://github.com/mozilla/rhino/issues/346
// eslint-disable-next-line no-prototype-builtins -- safe
return!D("z").propertyIsEnumerable(0)})?function(e){return"String"===A(e)?U(e,""):D(e)}:D;var z={},W={};// we can't use just `it == null` since of `document.all` special case
// https://tc39.es/ecma262/#sec-IsHTMLDDA-internal-slot-aec
W=function(e){return null==e};var G=TypeError;// `RequireObjectCoercible` abstract operation
// https://tc39.es/ecma262/#sec-requireobjectcoercible
z=function(e){if(W(e))throw new G("Can't call method on "+e);return e},x=function(e){return T(z(e))};var B={},Y={},J={},Q={},V={},K="object"==typeof document&&document.all,X=(V={all:K,IS_HTMLDDA:void 0===K&&void 0!==K}).all;// `IsCallable` abstract operation
...
!Symbol.sham&&eo&&eo<41}))&&!Symbol.sham&&"symbol"==typeof Symbol.iterator;var ef=Object;ee=en?function(e){return"symbol"==typeof e}:function(e){var t=et("Symbol");return Q(t)&&er(t.prototype,ef(e))};var ep={},eh={},ev={},eg=String;ev=function(e){try{return eg(e)}catch(e){return"Object"}};var em=TypeError;// `Assert: IsCallable(argument) is true`
...
ey=function(e,t){var r,n;if("string"===t&&Q(r=e.toString)&&!J(n=j(r,e))||Q(r=e.valueOf)&&!J(n=j(r,e))||"string"!==t&&Q(r=e.toString)&&!J(n=j(r,e)))return n;throw new eb("Can't convert object to primitive value")};var e_={},ew={};ew=!1;var ek={},eS={},eE=Object.defineProperty;eS=function(e,t){try{eE(k,e,{value:t,configurable:!0,writable:!0})}catch(r){k[e]=t}return t};var eF="__core-js_shared__";ek=k[eF]||eS(eF,{}),(e_=function(e,t){return ek[e]||(ek[e]=void 0!==t?t:{})})("versions",[]).push({version:"3.33.2",mode:ew?"pure":"global",copyright:"\xa9 2014-2023 Denis Pushkarev (zloirock.ru)",license:"https://github.com/zloirock/core-js/blob/v3.33.2/LICENSE",source:"https://github.com/zloirock/core-js"});var ej={},e$={},eO=Object;// `ToObject` abstract operation
// https://tc39.es/ecma262/#sec-toobject
e$=function(e){return eO(z(e))};var eL=H({}.hasOwnProperty);// `HasOwnProperty` abstract operation
// https://tc39.es/ecma262/#sec-hasownproperty
// eslint-disable-next-line es/no-object-hasown -- safe
ej=Object.hasOwn||function(e,t){return eL(e$(e),t)};var eM={},eP=0,ex=Math.random(),eT=H(1..toString);eM=function(e){return"Symbol("+(void 0===e?"":e)+")_"+eT(++eP+ex,36)};var eH=k.Symbol,eI=e_("wks"),eq=en?eH.for||eH:eH&&eH.withoutSetter||eM,eC=TypeError,eA=(ej(eI,e="toPrimitive")||(eI[e]=ei&&ej(eH,e)?eH[e]:eq("Symbol."+e)),eI[e]);// `ToPrimitive` abstract operation
// https://tc39.es/ecma262/#sec-toprimitive
Y=function(e,t){if(!J(e)||ee(e))return e;var r,n=ep(e,eA);if(n){if(void 0===t&&(t="default"),r=j(n,e,t),!J(r)||ee(r))return r;throw new eC("Can't convert object to primitive value")}return void 0===t&&(t="number"),ey(e,t)},// `ToPropertyKey` abstract operation
// https://tc39.es/ecma262/#sec-topropertykey
B=function(e){var t=Y(e,"string");return ee(t)?t:t+""};var eN={},eR={},eD=k.document,eU=J(eD)&&J(eD.createElement);eR=function(e){return eU?eD.createElement(e):{}},// Thanks to IE8 for its funny defineProperty
...
var ez=Object.getOwnPropertyDescriptor;i=E?ez:function(e,t){if(e=x(e),t=B(t),eN)try{return ez(e,t)}catch(e){}if(ej(e,t))return P(!j(o,e,t),e[t])};var eW={},eG={};// V8 ~ Chrome 36-
...
eB=function(e){if(J(e))return e;throw new eJ(eY(e)+" is not an object")};var eQ=TypeError,eV=Object.defineProperty,eK=Object.getOwnPropertyDescriptor,eX="enumerable",eZ="configurable",e0="writable";c=E?eG?function(e,t,r){if(eB(e),t=B(t),eB(r),"function"==typeof e&&"prototype"===t&&"value"in r&&e0 in r&&!r[e0]){var n=eK(e,t);n&&n[e0]&&(e[t]=r.value,r={configurable:eZ in r?r[eZ]:n[eZ],enumerable:eX in r?r[eX]:n[eX],writable:!1})}return eV(e,t,r)}:eV:function(e,t,r){if(eB(e),t=B(t),eB(r),eN)try{return eV(e,t,r)}catch(e){}if("get"in r||"set"in r)throw new eQ("Accessors not supported");return"value"in r&&(e[t]=r.value),e},eW=E?function(e,t,r){return c(e,t,P(1,r))}:function(e,t,r){return e[t]=r,e};var e1={},e2={},e4=Function.prototype,e3=E&&Object.getOwnPropertyDescriptor,e9=ej(e4,"name")&&(!E||E&&e3(e4,"name").configurable),e7={},e8=H(Function.toString);Q(ek.inspectSource)||(ek.inspectSource=function(e){return e8(e)}),e7=ek.inspectSource;var e5={},e6={},te=k.WeakMap;e6=Q(te)&&/native code/.test(String(te));var tt={},tr=e_("keys");tt=function(e){return tr[e]||(tr[e]=eM(e))};var tn={};tn={};var ti="Object already initialized",to=k.TypeError,ta=k.WeakMap;if(e6||ek.state){var ts=ek.state||(ek.state=new ta);/* eslint-disable no-self-assign -- prototype methods protection */ts.get=ts.get,ts.has=ts.has,ts.set=ts.set,/* eslint-enable no-self-assign -- prototype methods protection */u=function(e,t){if(ts.has(e))throw new to(ti);return t.facade=e,ts.set(e,t),t},l=function(e){return ts.get(e)||{}},d=function(e){return ts.has(e)}}else{var tc=tt("state");tn[tc]=!0,u=function(e,t){if(ej(e,tc))throw new to(ti);return t.facade=e,eW(e,tc,t),t},l=function(e){return ej(e,tc)?e[tc]:{}},d=function(e){return ej(e,tc)}}var tu=(e5={set:u,get:l,has:d,enforce:function(e){return d(e)?l(e):u(e,{})},getterFor:function(e){return function(t){var r;if(!J(t)||(r=l(t)).type!==e)throw new to("Incompatible receiver, "+e+" required");return r}}}).enforce,tl=e5.get,tf=String,tp=Object.defineProperty,th=H("".slice),tv=H("".replace),tg=H([].join),tm=E&&!F(function(){return 8!==tp(function(){},"length",{value:8}).length}),ty=String(String).split("String"),tb=e2=function(e,t,r){"Symbol("===th(tf(t),0,7)&&(t="["+tv(tf(t),/^Symbol\(([^)]*)\)/,"$1")+"]"),r&&r.getter&&(t="get "+t),r&&r.setter&&(t="set "+t),(!ej(e,"name")||e9&&e.name!==t)&&(E?tp(e,"name",{value:t,configurable:!0}):e.name=t),tm&&r&&ej(r,"arity")&&e.length!==r.arity&&tp(e,"length",{value:r.arity});try{r&&ej(r,"constructor")&&r.constructor?E&&tp(e,"prototype",{writable:!1}):e.prototype&&(e.prototype=void 0)}catch(e){}var n=tu(e);return ej(n,"source")||(n.source=tg(ty,"string"==typeof t?t:"")),e};// add fake Function#toString for correct work wrapped methods / constructors with methods like LoDash isNative
// eslint-disable-next-line no-extend-native -- required
Function.prototype.toString=tb(function(){return Q(this)&&tl(this).source||e7(this)},"toString"),e1=function(e,t,r,n){n||(n={});var i=n.enumerable,o=void 0!==n.name?n.name:t;if(Q(r)&&e2(r,o,n),n.global)i?e[t]=r:eS(t,r);else{try{n.unsafe?e[t]&&(i=!0):delete e[t]}catch(e){}i?e[t]=r:c(e,t,{value:r,enumerable:!1,configurable:!n.nonConfigurable,writable:!n.nonWritable})}return e};var t_={},tw={},tk={},tS={},tE={},tF={},tj=Math.ceil,t$=Math.floor;// `Math.trunc` method
...
tS=function(e,t){var r=tE(e);return r<0?tO(r+t,0):tL(r,t)};var tM={},tP={},tx=Math.min;// `ToLength` abstract operation
...
tw=et("Reflect","ownKeys")||function(e){var t=f(eB(e));return p?tC(t,p(e)):t},t_=function(e,t,r){for(var n=tw(t),o=0;o<n.length;o++){var a=n[o];ej(e,a)||r&&ej(r,a)||c(e,a,i(t,a))}};var tA={},tN=/#|\.prototype\./,tR=function(e,t){var r=tU[tD(e)];return r===tW||r!==tz&&(Q(t)?F(t):!!t)},tD=tR.normalize=function(e){return String(e).replace(tN,".").toLowerCase()},tU=tR.data={},tz=tR.NATIVE="N",tW=tR.POLYFILL="P";tA=tR,/*
...
if(a=t[n],o=e.dontCallGetSet?(s=i(r,n))&&s.value:r[n],!tA(u?n:c+(l?".":"#")+n,e.forced)&&void 0!==o){if(typeof a==typeof o)continue;t_(a,o)}(e.sham||o&&o.sham)&&eW(a,"sham",!0),e1(r,n,a,e)}};var tG={},tB={},tY=Function.prototype,tJ=tY.apply,tQ=tY.call;// eslint-disable-next-line es/no-reflect -- safe
tB="object"==typeof Reflect&&Reflect.apply||($?tQ.bind(tJ):function(){return tQ.apply(tJ,arguments)});var tV={},tK={},tX=(tK=function(e){// Nashorn bug:
//   https://github.com/zloirock/core-js/issues/1128
//   https://github.com/zloirock/core-js/issues/1130
if("Function"===A(e))return H(e)})(tK.bind);// optional / simple context binding
tV=function(e,t){return eh(e),void 0===t?e:$?tX(e,t):function(){return e.apply(t,arguments)}};var tZ={};tZ=et("document","documentElement");var t0={};t0=H([].slice);var t1={},t2=TypeError;t1=function(e,t){if(e<t)throw new t2("Not enough arguments");return e};var t4={};// eslint-disable-next-line redos/no-vulnerable -- safe
...
k.postMessage(rt(e),h.protocol+"//"+h.host)};t9&&t7||(t9=function(e){t1(arguments.length,1);var t=Q(e)?e:t6(e),r=t0(arguments,1);return rn[++rr]=function(){tB(t,void 0,r)},v(rr),rr},t7=function(e){delete rn[e]},t3?v=function(e){t8.nextTick(ra(e))}:t5&&t5.now?v=function(e){t5.now(ra(e))}:re&&!t4?(m=(g=new re).port2,g.port1.onmessage=rs,v=tV(m.postMessage,m)):k.addEventListener&&Q(k.postMessage)&&!k.importScripts&&h&&"file:"!==h.protocol&&!F(rc)?(v=rc,k.addEventListener("message",rs,!1)):v=ri in eR("script")?function(e){tZ.appendChild(eR("script"))[ri]=function(){tZ.removeChild(this),ro(e)}}:function(e){setTimeout(ra(e),0)});var ru=(tG={set:t9,clear:t7}).clear;// `clearImmediate` method
...
w({global:!0,bind:!0,enumerable:!0,forced:k.setImmediate!==rv},{setImmediate:rv});const rg="https://forkify-api.herokuapp.com/api/v2/recipes/",rm="9ea3e4b3-4246-4ba6-8f62-3bac42e8a1e9",ry=async function(e,t){try{// Using ternary operator for clearity
...
rb.bookmarks.push(e),e.id===rb.recipe.id&&(rb.recipe.bookmarked=!0),rF()},r$=function(e){// Delete the bookmark
let t=rb.bookmarks.findIndex(t=>t.id===e);// console.log("index",index);
rb.bookmarks.splice(t,1),e===rb.recipe.id&&(rb.recipe.bookmarked=!1),rF()};localStorage.clear("bookmark");const rO=async function(e){// create a new recipe object
...
n.forEach((e,t)=>{let r=i[t];r.isEqualNode(e)||e.firstChild?.nodeValue.trim()===""||(r.textContent=e.textContent),e.isEqualNode(r)||Array.from(e.attributes).forEach(e=>{r.setAttribute(e.name,e.value)})})}_clear(){this._parentElement.innerHTML=""}// spinner function
...
1===e&&t>1?`  <button data-goto="${e+1}" class="btn--inline pagination__btn--next">
    ...
    </button>`:"")}}var rN=new rA;// import icons from '../img/icons.svg'
class rR extends rM{_parentElement=document.querySelector(".bookmarks__list");_errorMessage="No bookmarks yet. Find a nice recipe and bookmark it :)";_message="";addHandlerRender(e){window.addEventListener("load",e)}_generateMarkUp(){// console.log(this._data);
// Render as a String // by default in the render
// We can't use the preview view itself because we need to render the data property that we parse in
return this._data.map(e=>rI.render(e,!1)).join("")}}var rD=new rR;class rU extends rM{_parentElement=document.querySelector(".upload");_message="Add Recipe was successfully Uploaded :)";_window=document.querySelector(".add-recipe-window");_overlay=document.querySelector(".overlay");_btnClose=document.querySelector(".btn--close-modal");_btnOpen=document.querySelector(".nav__btn--add-recipe");constructor(){super(),this._addHandlerShowWindow(),this._addHandlerHideWindow()}// Toggle function for  window
...
if(!e)return;rC.update(rS()),rD.update(rb.bookmarks),rx.renderSpinner(),// load recipe
...
await rk(e),rx.HandlerMessageRender(),rC.render(rS()),rN.render(rb.search);// console.log(model.state.recipe);
}catch(e){console.error(`${e}`)}},rY=async function(e){try{rz.renderSpinner(),// Upload the new addedRecipe
await rO(e),console.log(rb.recipe),rx.render(rb.recipe),rz.HandlerMessageRender(),rD.render(rb.bookmarks),// Change the ID in the  URL
window.history.pushState(null,"",`#${rb.recipe.id}`),// SetTimeout for the addedRecipe
setTimeout(()=>rz.toggleWindow(),2500)}catch(e){console.error("❤️‍\uD83D\uDD25",e),rz.erroHandlerRender(e.message)}};rx.addHandlerRender(function(){rD.render(rb.bookmarks)}),rx.addHandlerRender(rG),rx.addHandlerUpdateIng(function(e){// update the recipe servings
rE(e),rx.update(rb.recipe)}),rx.addHandlerAddBookmark(function(){rb.recipe.bookmarked?r$(rb.recipe.id):rj(rb.recipe),rx.update(rb.recipe),rD.render(rb.bookmarks)}),rH.addHandlerSearch(rB),rN._addHandlerClick(function(e){rC.render(rS(e)),rN.render(rb.search)}),rz._addHandlerUploadFile(rY);// window.addEventListener('hashchange',recipeRequest)
// window.addEventListener('load',recipeRequest)
//# sourceMappingURL=index.6eb34b37.js.map
